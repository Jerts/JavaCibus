...
public class Sesion implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if(s1.getAttribute("usuario")!=null ){
            ...
            res.sendRedirect("/Cibus/index.html");
        }
    }
    private boolean PeticionValida(HttpServletRequest req) {
        //validamos la url
        boolean result = true;
        String uri = req.getRequestURI();
        //solo validamos las peticiones que sean a recursos HTML
        //y que sean distintas a la página inicial
        if (uri.endsWith("html") && !uri.equals("/Cibus/index.html")) {
            result = false;
        }
        return result;
    }
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("Sesion:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("Sesion(");
